...
/*   Updated: 2023/08/04 16:20:53 by spapyan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
RPN::result_type RPN::resolveExpression(const std::string &line)
{
    ...
    if (stack_.size() > 1)
        throw std::runtime_error("Operations ended and tack has more than 1 item");
...
void    RPN::operate(op_type symbol)
{
    ...
    throw std::runtime_error("Encountered and undefined operator");
}
